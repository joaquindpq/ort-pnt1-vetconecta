        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VeterinariaId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Duenos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Duenos_AspNetUsers_VeterinariaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Mascotas_AspNetUsers_VeterinariaId",
                        column: x => x.VeterinariaId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Turnos_AspNetUsers_VeterinariaId",
                        column: x => x.VeterinariaId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Duenos_Dni_VeterinariaId",
                table: "Duenos",
                columns: new[] { "Dni", "VeterinariaId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Duenos_VeterinariaId",
                table: "Duenos",
